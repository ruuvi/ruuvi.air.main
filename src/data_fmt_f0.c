    ...
    const uint64_t                     radio_mac)
{
    const re_f0_data_t data = {
        ...
        .voc_index     = sen66_wrap_conv_raw_to_float_voc_index(p_measurement->sen66.voc_index),
        .nox_index     = sen66_wrap_conv_raw_to_float_nox_index(p_measurement->sen66.nox_index),
