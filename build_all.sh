...
declare -A pids
declare -a scripts=(
    "build_nrf52840dk_hw1_debug_mock.sh"
    "build_nrf52840dk_hw1_debug.sh"
    "build_nrf52840dk_hw1_release_mock.sh"
    "build_nrf52840dk_hw1_release.sh"
    "build_nrf52840dk_hw2_debug_mock_df_e0_f0.sh"
    "build_nrf52840dk_hw2_debug_mock.sh"
    "build_nrf52840dk_hw2_debug.sh"
    "build_nrf52840dk_hw2_release_mock_df_e0_f0.sh"
    "build_nrf52840dk_hw2_release_mock.sh"
    "build_nrf52840dk_hw2_release.sh"
    "build_ruuviair_hw1_debug.sh"
    "build_ruuviair_hw1_release_df_e0_f0.sh"
    "build_ruuviair_hw1_release.sh"
    "build_ruuviair_hw2_debug.sh"
    "build_ruuviair_hw2_release_df_e0_f0.sh"
    "build_ruuviair_hw2_release-dev.sh"
    "build_ruuviair_hw2_release-prod.sh"
    "build_ruuviair_hw2_debug_fw_led_cycle_calibrate.sh"
    "build_ruuviair_hw2_debug_fw_led_cycle_rgbw.sh"
    "build_ruuviair_hw2_debug_fw_opt4060_measurements.sh"
    "build_ruuviair_hw2_release_fw_led_cycle_calibrate.sh"
    "build_ruuviair_hw2_release_fw_led_cycle_rgbw.sh"
    "build_ruuviair_hw2_release_fw_opt4060_measurements.sh"
)
